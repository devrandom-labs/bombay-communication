...
/// hanging the whole run — essential for the verification measure loop.
#[macro_export]
macro_rules! property_suite {
    ($fp:ident) => {
        mod communication_property_suite {
            ...
            // ——— UserAnchor (address-table endpoint, card 3) ———
